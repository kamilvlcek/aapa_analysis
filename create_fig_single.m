function create_fig_single (is_room, file_name, phase, room_x, room_y, room_ent_all_X, room_ent_all_Y, diamant_ent_room_x, diamant_ent_room_y, sector_x_input, sector_y_input, unreal_abund, unreal_mis, view_coord)
...
%plot sector
if (is_room == 1 & phase ~= 3) | (is_room == 0 & phase == 3)
